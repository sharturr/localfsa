...
function lecture_notify(text) {
  var divpop = document.createElement('div');
    ...
    divcontent.innerHTML = text + '<br>https://moodle.tsu.ru/pluginfile.php/1066649/mod_resource/content/1/минимизация.pdf';
    ...
    link.href = 'https://moodle.tsu.ru/pluginfile.php/1066649/mod_resource/content/1/минимизация.pdf';
    link.target = "_blank";
